...
if plot:
    ...
    if compare:
        ...
        plt.figure(figsize=(6,4))
        plt.plot(theta_width, ratio5, '--', c = 'b', label = r'HiRes - Low t/t$_{fb}=$ 0.5')
        plt.plot(theta_width, ratio5Res20, '--', c = 'green', label = r'Res20 - Low t/t$_{fb}=$ 0.5')
        plt.plot(theta_width, ratio7, c = 'b', label = r'HiRes - Low t/t$_{fb}=$ 0.7')
        plt.xlabel(r'$\theta$', fontsize = 14)
