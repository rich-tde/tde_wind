...
for idx_s, snap in enumerate(snaps):
    ...
    if save:
        ...
        with open(f'{pre_saving}/photo/{check}_photo{snap}.txt', 'w') as f:
            ...
            f.write('xph' + ' '.join(map(str, xph)) + '\n')
            f.write('yph' + ' '.join(map(str, yph)) + '\n')
            f.write('zph' + ' '.join(map(str, zph)) + '\n')
            f.write('volph' + ' '.join(map(str, volph)) + '\n')
            f.write('denph CGS' + ' '.join(map(str, denph)) + '\n')
            f.write('Tempph' + ' '.join(map(str, Tempph)) + '\n')
            f.write('Rad_denph' + ' '.join(map(str, Rad_denph)) + '\n')
            f.write('Vxph' + ' '.join(map(str, Vxph)) + '\n')
            f.write('Vyph' + ' '.join(map(str, Vyph)) + '\n')
            f.write('Vzph' + ' '.join(map(str, Vzph)) + '\n')
            f.write('alpha CGS' + ' '.join(map(str, alphaph)) + '\n')
            f.write('rph' + ' '.join(map(str, rph)) + '\n')
            f.write('Lph CGS' + ' '.join(map(str, Lph)) + '\n')
            f.close()
