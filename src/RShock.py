...
ax1.plot(timeRDiss, RDiss/Rt,  color = '#f768a1', label = r'$r_{\rm diss}$')
ax1.plot(tfb, R_ph/Rt, color = '#7570b3', label = r'$r_{\rm ph}$')
...
ax.plot(timeRDiss, eta_checkRdiss, color = '#f768a1', label = r'$\eta_{\rm diss}= GM/(r_{\rm diss}c^2)=r_{\rm g}/r_{\rm diss}$')
