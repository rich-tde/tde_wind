...
def extractor(filename):
    ...
    # Close the file
    f.close()
    return DpDx, DpDy, DpDz #box, X, Y, Z, Den, Vx, Vy, Vz, Vol, Mass, IE, Erad, T, P, Star, Diss, Entropy, DpDx, DpDy, DpDz
