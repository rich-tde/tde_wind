...
# Converters
tsol_cgs = 1603 #np.sqrt(Rsol_cgs**3 / (Msol_cgs*G_cgs )) # ~1593 with more digits for Msol Rsol (RICH: 1603). Follows from G = 1. To pass from code units to cgs, you multiply by tsol_cgs
