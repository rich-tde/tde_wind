...
tfb_Low = np.loadtxt(f'{path}/coloredE_Low_days.txt')[1]
dataLow = np.load(f'{path}/coloredE_Low.npy')
...
radii = np.load(f'{path}/coloredE_HiRes_radii.npy')#np.logspace(np.log10(R0), np.log10(apo), num=100)
radii /=apo
