...
ax1.plot(massL, cumL, color = '#d95f02')#, label = 'This work, Low res')
ax1.text(3e-9, 0.39, 'Low', fontsize = 18, rotation = 40)
ax1.plot(mass, cum, color = '#b2df8a')#, label = 'This work, Fid res')
ax1.text(6e-10, 0.335, 'Middle', fontsize = 18, rotation = 34)
ax1.plot(massH, cumH, color = '#7570b3') #, label = 'This work, High res')
...
ax2.plot(dim_cellL, cumdimL, color = '#d95f02')# label = 'Low res')
ax2.plot(dim_cell, cumdim, color = '#b2df8a')# label = 'Middle res')
ax2.plot(dim_cellH, cumdimH, color = '#7570b3',)# label = 'High res')
ax2.axvline(sizemeanRyu, color = 'k', linestyle = (0, (5, 10)), label = 'Ryu+23 gmean orb.plane')
ax2.axvline(sizeminRyu, color = 'k', linestyle = '--', label = 'Ryu+23 min orb.plane')
ax2.axvline(sizehuang24, color = 'deepskyblue', linestyle = 'dashdot', label = 'Huang+24')

if include_mid == 'mid':
    ax1.plot(mass_midplaneL, cum_midplaneL, '--', color = '#d95f02')#, label = 'Low res')
    ax1.plot(mass_midplane, cum_midplane, '--', color = '#b2df8a')#, label = 'Fid res')
    ax1.plot(mass_midplaneH, cum_midplaneH, '--', color = '#7570b3')#, label = 'High res')
    ax2.plot(dim_midplaneL, cum_midplanedimL, '--', color = '#d95f02')# label = 'Low res')
    ax2.plot(dim_midplane, cum_midplanedim, '--', color = '#b2df8a')# label = 'Middle res')
    ax2.plot(dim_midplaneH, cum_midplanedimH, '--', color = '#7570b3',)# label = 'High res')
