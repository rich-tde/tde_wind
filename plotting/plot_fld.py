...
ax1.scatter(tfbL, Lum_L, s = 4, label= 'Low', c= 'C1')
ax1.scatter(tfb, Lum, s = 4, label = 'Fid', c ='yellowgreen')
ax1.scatter(tfbH, Lum_H, s = 4, label= 'High', c = 'darkviolet')
...
ax2.scatter(tfbL, np.abs(diffL), color = 'C1', s = 4, label = 'Low')
ax2.scatter(tfbH, np.abs(diffH), color = 'darkviolet', s = 4, label = 'High')
ax2.set_yscale('log')
