...
if __name__ == '__main__':
    ...
    # Photosphere
    axR.plot(tfbL, median_phL/Rt, c = '#d95f02', label = 'Low')
    axR.plot(tfbL, percentile84L/Rt, c = '#d95f02', alpha = 0.4, linestyle = '--')
    axR.plot(tfbL, percentile16L/Rt, c = '#d95f02', alpha = 0.4, linestyle = '--')
    axR.fill_between(tfbL, percentile16L/Rt, percentile84L/Rt, color = '#d95f02', alpha = 0.4)
    #Middle
    axR.plot(tfb, median_ph/Rt, c = '#b2df8a', label = 'Middle')
    axR.plot(tfb, percentile84/Rt, c = '#b2df8a', alpha = 0.3, linestyle = '--')
    axR.plot(tfb, percentile16/Rt, c = '#b2df8a', alpha = 0.3, linestyle = '--')
    axR.fill_between(tfb, percentile16/Rt, percentile84/Rt, color = '#b2df8a', alpha = 0.3)
    # High
    axR.plot(tfbH, median_phH/Rt, c = '#7570b3', label = 'High')
    axR.plot(tfbH, percentile84H/Rt, c = '#7570b3', alpha = 0.2, linestyle = '--')
    axR.plot(tfbH, percentile16H/Rt, c = '#7570b3', alpha = 0.2, linestyle = '--')
    axR.fill_between(tfbH, percentile16H/Rt, percentile84H/Rt, color = '#7570b3', alpha = 0.2)
    ...
    axR_err.plot(tfb_ratioL_Rph, ratio_medianRphL, linewidth = 2, color = '#b2df8a')
    axR_err.plot(tfb_ratioL_Rph, ratio_medianRphL, linestyle = (0, (5, 10)), linewidth = 2, color = '#d95f02')
    tfb_ratioH_Rph, ratio_medianRphH, rel_errphH = ratio_BigOverSmall(tfb, median_ph, tfbH, median_phH)
    axR_err.plot(tfb_ratioH_Rph, ratio_medianRphH, linewidth = 2, color = '#b2df8a')
    axR_err.plot(tfb_ratioH_Rph, ratio_medianRphH, linestyle = (0, (5, 10)), linewidth = 2, color = '#7570b3')
    ...
    axL.plot(tfbL, LumL, c = '#d95f02', label = 'Low')
    axL.plot(tfbdissL, LDissL, ls = '--', c = '#d95f02')
    axL.plot(tfb, Lum, c = '#b2df8a', label = 'Middle')
    axL.plot(tfbdiss, LDiss, ls = '--', c = '#b2df8a')
    axL.plot(tfbH, LumH, c = '#7570b3', label = 'High')
    axL.plot(tfbdissH, LDissH, ls = '--', c = '#7570b3')
    ...
    # axL_err.plot(tfb_ratioDiss, ratioDiss, linewidth = 2, color = '#d95f02', ls = '--')
    tfb_ratioL, ratioL, rel_errL  = ratio_BigOverSmall(tfb, Lum, tfbL, LumL)
    axL_err.plot(tfb_ratioL, ratioL, linewidth = 2, color = '#b2df8a')
    axL_err.plot(tfb_ratioL, ratioL, linewidth = 2, color = '#d95f02', linestyle = (0, (5, 10)), label = 'Low,Middle')
    # axL_errperc.plot(tfb_ratioL, rel_errL, linewidth = 2, color = '#d95f02', linestyle = (0, (5, 10)), label = 'Low,Middle')
    tfb_ratioDissH, ratioDissH, _  = ratio_BigOverSmall(tfbdissH, LDissH, tfbdiss, LDiss)
    # axL_err.plot(tfb_ratioDissH, ratioDissH, linewidth = 2, color = '#7570b3', ls = '--')
    tfb_ratioH, ratioH, rel_errH  = ratio_BigOverSmall(tfb, Lum, tfbH, LumH)
    axL_err.plot(tfb_ratioH, ratioH, linewidth = 2, color = '#b2df8a')
    axL_err.plot(tfb_ratioH, ratioH, linewidth = 2, color = '#7570b3', linestyle = (0, (5, 10)), label = 'Middle,High')
    ...
    ax1.plot(tfb_oeL, col_orb_en_negL*prel.en_converter*1e-49, label = r'Low', c = '#d95f02')
    ax1.plot(tfb_oe, col_orb_en_neg*prel.en_converter*1e-49, label = r'Middle', c = '#b2df8a')
    ax1.plot(tfb_oeH, col_orb_en_negH*prel.en_converter*1e-49, label = r'High', c = '#7570b3')
    ax1.set_title(r'Orbital Energy ($10^{49}$ erg) bound gas', fontsize = 30)
    ax1.set_ylabel(r'Energy', fontsize = 40) 
    ax1.legend(fontsize = 15)

    ax2.plot(tfb_oeL, col_orb_en_posL*prel.en_converter*1e-49, label = r'Low', c = '#d95f02')
    ax2.plot(tfb_oe, col_orb_en_pos*prel.en_converter*1e-49, label = r'Middle', c = '#b2df8a')
    ax2.plot(tfb_oeH, col_orb_en_posH*prel.en_converter*1e-49, label = r'High', c = '#7570b3')
    ax2.set_title(r'Orbital Energy ($10^{49}$ erg) unbound gas', fontsize = 30)

    ax3.plot(tfb_oeL, col_ieL*prel.en_converter*1e-46, label = r'Low', c = '#d95f02')
    ax3.plot(tfb_oe, col_ie*prel.en_converter*1e-46, label = r'Middle', c = '#b2df8a')
    ax3.plot(tfb_oeH, col_ieH*prel.en_converter*1e-46, label = r'High', c = '#7570b3')
    ax3.set_title(r'Thermal energy ($10^{46}$ erg)', fontsize = 30)  

    axR.plot(tfb_oeL, col_radL*prel.en_converter, label = r'Low', c = '#d95f02')
    axR.plot(tfb_oe, col_rad*prel.en_converter, label = r'Middle', c = '#b2df8a')
    axR.plot(tfb_oeH, col_radH*prel.en_converter, label = r'High', c = '#7570b3')
    axR.set_title(r'Radiation energy (erg)', fontsize = 30)
    axR.set_yscale('log')
    axR.set_ylim(5e43, 2e48)
    
    ax4.plot(tfb_ratio_orbnegL, ratio_orbnegL, linewidth = 2.5, c = '#d95f02',  label = r'Low andMiddledle',)
    ax4.plot(tfb_ratio_orbnegL, ratio_orbnegL, linestyle = (0, (5, 10)), linewidth = 2, c = '#b2df8a')
    ax4.plot(tfb_ratio_orbnegH, ratio_orbnegH,  label = r'Middle and High', linewidth = 2, c = '#7570b3')
    ax4.plot(tfb_ratio_orbnegH, ratio_orbnegH, linestyle = (0, (5, 10)), linewidth = 2, c = '#b2df8a')
    ax4.set_ylabel(r'$\mathcal{R}$', fontsize = 40)
    ax4.set_ylim(1, 1.015)

    ax5.plot(tfb_ratio_orbnegL, ratio_orbposL, label = r'Low andMiddledle', linewidth = 2, c = '#d95f02')
    ax5.plot(tfb_ratio_orbnegL, ratio_orbposL, linestyle = (0, (5, 10)), linewidth = 2, c = '#b2df8a')
    ax5.plot(tfb_ratio_orbnegH, ratio_orbposH, label = r'Middle and High', linewidth = 2, c = '#7570b3')
    ax5.plot(tfb_ratio_orbnegH, ratio_orbposH, linestyle = (0, (5, 10)), linewidth = 2, c = '#b2df8a')
    ax5.set_ylim(1, 1.015)

    ax6.plot(tfb_ratio_orbL, ratio_ieL, label = r'Low andMiddledle', linewidth = 2, c = '#d95f02')
    ax6.plot(tfb_ratio_orbL, ratio_ieL, linestyle = (0, (5, 10)), linewidth = 2, c = '#b2df8a')
    ax6.plot(tfb_ratio_orbH, ratio_ieH, label = r'Middle and High', linewidth = 2, c = '#7570b3')
    ax6.plot(tfb_ratio_orbH, ratio_ieH, linestyle = (0, (5, 10)), linewidth = 2, c = '#b2df8a')
    
    ax7.plot(tfb_ratio_orbL, ratio_radL, linewidth = 2.5, c = '#d95f02',  label = r'Low andMiddledle',)
    ax7.plot(tfb_ratio_orbL, ratio_radL, linestyle = (0, (5, 10)), linewidth = 2, c = '#b2df8a')
    ax7.plot(tfb_ratio_orbH, ratio_radH, label = r'Middle and High', linewidth = 2, c = '#7570b3')
    ax7.plot(tfb_ratio_orbH, ratio_radH,linestyle = (0, (5, 10)), linewidth = 2, c = '#b2df8a')
    ax7.set_ylim(.99, 2.5)
